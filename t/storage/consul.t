...
our $HttpConfig = qq{
    ...
    init_by_lua_block {
        _G.test_lib = require("resty.acme.storage.consul")
        _G.test_cfg = nil
        _G.test_ttl = 0.1
    }
};
...
=== TEST 7: Consul add only set when key not exist
--- http_config eval: $::HttpConfig
--- config
    location =/t {
        content_by_lua_block {
